...
const Home = () => {
  return (
    <motion.section
      ...
      className="h-[calc(100vh-5rem)] flex items-center"
    >
      <div className="flex flex-col xl:flex-row items-center justify-around w-full">
        <div className="w-full xl:w-[550px] flex flex-col items-center xl:items-start text-center xl:text-left">
          ...
          <h3 className="max-w-[500px]">I'm a software developer, always eager to tackle new challenges.</h3>
          <button className="btn btn-lg btn-accent mt-5">See my projects</button>
        </div>
